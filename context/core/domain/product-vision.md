...
aveAI is a lightweight CLI tool for storing and retrieving structured context data that AI agents can query. It fills the gap between "random files in a directory" and "running a full vector database."
